        ...
        <div className={styles.blogContainer}>
            ...
            <div className={styles.blogWrap}>
                ...
                <div className={styles.description}>
                    ...
                    <div className={styles.icons}> <BsHandThumbsUp/> <BsArrowUpRightSquare/> <BsMedium/> </div>
                </div>
            </div>
            <div className={styles.blogWrap}>
                <div >
                ...
                <div className={styles.description}>
                    ...
                    <p className={styles.tags}>C++ | Object Oriented Programming | Data Structres</p>
                    <div className={styles.icons}> <BsHandThumbsUp/> <BsArrowUpRightSquare/> <AiOutlineYoutube/> </div>
                </div>
            </div>
            <div className={styles.blogWrap}>
                <div >
